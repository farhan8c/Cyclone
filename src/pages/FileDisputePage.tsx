...
import { Check, Info, ShieldAlert, ArrowRight, ArrowLeft, Users, User, Wallet } from 'lucide-react';
...
export const FileDisputePage: React.FC = () => {
  ...
  // Validate allowance when step changes or amount/token changes
  useEffect(() => {
    let active = true;
  ...
  }, [tokenSymbol, amount, address, checkAllowance]);
          ...
          <div className="bg-white border border-[#d4c1cd]/40 rounded-2xl p-10 text-center shadow-sm space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-[#50434c] max-w-md mx-auto">
                Connect your wallet to file a dispute on Arc Testnet, escrow funds, and select juror panels.
              </p>
            </div>
                ...
                {currentStep === 2 && (
                  ...
                  >
                    ...
                    <div className="bg-[#f5f3f3] p-4 rounded-xl border border-[#d4c1cd]/40 text-sm text-[#50434c] flex items-start gap-3">
                      ...
                      <div>
                        This amount will be locked in the Cycloone escrow smart contract on Arc Testnet until a majority verdict is reached by jurors.
                      </div>
                    </div>
                      ...
                      {!hasAllowance && (
                        <div className="p-4 rounded-xl bg-amber-50 border border-amber-200 text-amber-900 text-sm space-y-2">
                          ...
                          <p className="text-xs text-amber-800">
                            Before filing, you must approve the Cycloone contract to escrow {amount} {tokenSymbol} from your wallet.
                          </p>
                          <button
